...
const img3 = document.getElementById('carousel3');
...
const moveRight3 = () => {
    if (position3 >= pictures3.length - 1) {
        position3 = 0
        img3.src = pictures3[position3];
        return;
    }
    img3.src = pictures3[position3 + 1];
    position3++;
}

const moveLeft3 = () => {
    if (position3 < 1) {
        position3 = pictures3.length - 1;
        img3.src = pictures3[position3];
        return;
    }
    img3.src = pictures3[position3 - 1];
...
rightBtn3.addEventListener("click", moveRight3);
leftBtn3.addEventListener("click", moveLeft3);
...
document.querySelector('.burger').addEventListener('click', function() {
    ...
    document.querySelector('.HeaderLinks').classList.toggle('open');
})

document.querySelector('.HeaderLinks').addEventListener('click', (e) => {
